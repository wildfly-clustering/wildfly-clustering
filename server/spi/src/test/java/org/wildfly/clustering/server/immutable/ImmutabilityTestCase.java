...
public class ImmutabilityTestCase {
	...
	protected void test(Immutability immutability) throws Exception {
		...
		assertTrue(immutability.test(new AbstractMap.SimpleImmutableEntry<>(Boolean.TRUE, Boolean.TRUE)));
		...
		assertFalse(immutability.test(new AbstractMap.SimpleEntry<>(Boolean.TRUE, Boolean.TRUE)));
	}
