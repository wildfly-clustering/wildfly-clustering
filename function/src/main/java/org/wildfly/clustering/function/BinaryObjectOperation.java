...
interface BinaryObjectOperation<V1, V2> {
	 ...
	 * @param <T1> the former mapped type
	 * @param <T2> the latter mapped type
	 * @param beforeFormer a mapping function for the former parameter
	 * @param beforeLatter a mapping function for the latter parameter
