...
public interface IntToDoubleFunction extends java.util.function.IntToDoubleFunction, IntOperation, ToDoubleOperation {
	...
	@Override
	default IntToDoubleFunction compose(Runnable before) {
	...
	@Override
	default IntToDoubleFunction thenRun(Runnable after) {
	 ...
	 */
	static IntToDoubleFunction of(java.util.function.IntToDoubleFunction before, Runnable after) {
		return new IntToDoubleFunction() {
			@Override
	 ...
	 * @return a composite function
	 */
	static IntToDoubleFunction of(Runnable before, java.util.function.IntToDoubleFunction after) {
		return new IntToDoubleFunction() {
			@Override
			public double applyAsDouble(int value) {
				before.run();
