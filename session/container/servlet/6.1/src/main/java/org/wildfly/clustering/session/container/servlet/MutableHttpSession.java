...
public class MutableHttpSession<C> extends ImmutableHttpSession<Session<C>> {
	...
	MutableHttpSession(Supplier<String> identifier, Reference<Session<C>> reference, ServletContext context, java.util.function.Function<String, Accessor> accessorFactory) {
		super(identifier, reference, context, accessorFactory);
