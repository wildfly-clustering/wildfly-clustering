...
public class ImmutableHttpSession extends AbstractHttpSession {
	...
	private final java.util.function.Supplier<Accessor> accessor;

	ImmutableHttpSession(java.util.function.Supplier<String> identifier, Reference<? extends ImmutableSession> reference, ServletContext context, java.util.function.Supplier<Accessor> accessor) {
		super(context);
